...
public class ServerStream : MonoBehaviour {
    ...
    {
        // Misc Animal         
        dataList = new List<string>() {"Astatumen_trinacriae", "Hypsibius_convergens", "Macrobiotus_tonollii"};
        ...
        // Reptile              
        Reptile = new List<string>() {"Packera_anonyma", "Podophyllum_peltatum", "Asplenium_montanum"  };
        ...
        DataManager.LoadEnvData("species_parallel_allSpecies", 49, dataList1);
